...
pub use self::path::{
    EntityObserveSystem, EntityTreeSystem, PathFindingSystem, PathMetadataSystem,
    TargetMetadataSystem, WalkTowardsSystem,
};
pub use self::{
...
pub fn setup_dispatcher(world: &mut World) {
    world.set_dispatcher(|| get_dispatcher_builder());
}
