 ...
 */
export declare class SharedWorkerPool {
    Proto: new () => SharedWorker;
    options: SharedWorkerPoolOptions;
    /**
     ...
     */
    constructor(Proto: new () => SharedWorker, options?: SharedWorkerPoolOptions);
    /**
     * Append a new job to be executed by a worker.
     *
     * @param job The job to queue.
     */
    addJob: (job: SharedWorkerPoolJob) => void;
    /**
...
//# sourceMappingURL=shared-worker-pool.d.ts.map