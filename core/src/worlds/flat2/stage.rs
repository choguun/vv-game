...
impl ChunkStage for GridLandStage {
    ...
    fn process(&self, mut chunk: Chunk, r: Resources, _: Option<Space>) -> Chunk {
        ...
        let adminium = registry.get_block_by_name("Adminium");
        ...
        for vx in min_x..max_x {
            for vz in min_z..max_z {
                ...
                if vx == 0 || vz == 0 {
                    chunk.set_voxel(vx, (self.top_height - 1) as i32, vz, adminium.id);
                }
            }
        }
